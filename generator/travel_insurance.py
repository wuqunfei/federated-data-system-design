    ...
    def generate(self):
        ...
        for tid in range(1, 101):
            ...
            travelers.append({
                ...
                'medical_conditions_list': json.dumps([random.choice(['Asthma', 'Diabetes', 'None'])]),
                'vaccination_record': json.dumps({'YellowFever': '2020-01-01', 'COVID19': '2021-03-01'}),
                'loyalty_program_status': json.dumps({'Lufthansa': random.choice(['Silver','Gold','Senator']), 'Marriott': random.choice(['None','Gold','Titanium'])}),
            ...
            for _ in range(num_trips):
                ...
                trips.append({
                    ...
                    'layover_airport_codes': json.dumps([random.choice(['LHR','DXB','SIN','IST','CDG','FRA'])]),
                ...
                policies.append({
                    ...
                    'coverage_limits_map': json.dumps(coverage_map),
                    ...
                    'bind_date': datetime.datetime.now(datetime.timezone.utc)
                })
    ...
    def connect(self) -> bool:
        ...
        try:
            self.engine = create_engine(
                ...
                future=True,
                pool_pre_ping=True,
                creator=lambda: dbsql.connect(server_hostname=host, http_path=http_path, access_token=token, catalog=self.catalog, schema=self.schema),
            )
